...
class CNNKANNet(nn.Module):
    def __init__(self, in_channels, hidden_channels, input_size, out_features, grid, degree, grid_range, device='cuda:0'):
        ...
        self.linear1 = MyKANLayer(final_dim*final_dim*hidden_channels[4], out_features, 
                                    grid=grid, degree=degree, grid_range=grid_range, approx_type='spline', device=device)
